...
export const metadata = { title: 'Technical Signals' };

const features = [
  { title: '30+ Indicators', desc: 'RSI, MACD, Bollinger Bands, Ichimoku, and dozens more — pre-computed daily for the full IDX universe.' },
  { title: 'Custom Signal Builder', desc: 'Combine indicators with logical operators to create proprietary signals without writing code.' },
  { title: 'Backtesting Integration', desc: 'Route signals directly into the Pyhron backtesting engine to validate performance before deployment.' },
];
    ...
    <div className="bg-white">
      <section className="border-b border-black/[0.06] py-16">
        <div className="mx-auto max-w-6xl px-6">
          <h1 className="text-3xl font-bold text-black">Technical Signals</h1>
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-black/50">
            Pre-computed technical indicators and a flexible signal builder to power systematic trading strategies on the IDX.
          </p>
        </div>
      </section>
