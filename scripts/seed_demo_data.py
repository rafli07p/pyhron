...
BASE_PRICES = {
    "BBCA": 9800, "BBRI": 5100, "BMRI": 6800, "TLKM": 3800, "ASII": 5200,
    "UNVR": 4200, "BBNI": 5500, "BRIS": 2700, "INDF": 6800, "ICBP": 11500,
    "KLBF": 1650, "HMSP": 880, "GGRM": 28000, "ADRO": 3200, "ITMG": 27000,
    "PTBA": 2800, "ANTM": 1800, "INCO": 4500, "MDKA": 2400, "EXCL": 2200,
    "SIDO": 750, "MAPI": 1850, "ACES": 780, "CPIN": 5200, "JPFA": 1450,
    "MEDC": 1350, "PGAS": 1550, "ESSA": 850, "TOWR": 1100, "TBIG": 2150,
    "SMGR": 4200, "INKP": 8500, "BRPT": 1150, "AMRT": 2800, "ERAA": 560,
    "MNCN": 780, "SCMA": 192, "AKRA": 1500, "UNTR": 28000, "BBTN": 1350,
    "BSDE": 1100, "CTRA": 1200, "SMRA": 620, "PWON": 440, "JSMR": 4500,
    "WIKA": 410, "WSKT": 350, "PTPP": 520, "TPIA": 5800, "EMTK": 550,
}

# Fundamental ratios (P/E, P/B, ROE%, dividend yield%, debt/equity)
FUNDAMENTALS = {
    "BBCA": (25.3, 5.2, 21.5, 1.8, 0.0), "BBRI": (12.8, 2.5, 19.8, 3.2, 0.0),
    "BMRI": (10.5, 1.8, 18.2, 4.5, 0.0), "TLKM": (14.2, 3.1, 22.5, 4.8, 0.85),
    "ASII": (8.5, 1.4, 16.8, 5.2, 0.62), "UNVR": (35.2, 42.5, 125.3, 2.8, 2.85),
    "BBNI": (7.8, 1.2, 15.5, 5.8, 0.0), "BRIS": (18.5, 3.8, 15.2, 1.2, 0.0),
    "INDF": (7.2, 1.3, 18.5, 4.2, 0.95), "ICBP": (18.5, 3.8, 21.2, 2.5, 0.45),
    "KLBF": (22.5, 3.2, 14.8, 2.2, 0.18), "HMSP": (12.8, 5.8, 45.2, 8.5, 0.12),
    "GGRM": (14.2, 1.8, 12.5, 3.8, 0.22), "ADRO": (5.8, 1.2, 22.8, 8.5, 0.35),
    "ITMG": (4.2, 1.5, 35.8, 12.5, 0.28), "PTBA": (6.5, 1.8, 28.5, 9.2, 0.15),
    "ANTM": (8.5, 1.2, 14.2, 3.5, 0.35), "INCO": (12.5, 1.8, 14.5, 2.8, 0.08),
    "MDKA": (35.2, 3.5, 10.2, 0.0, 0.65), "EXCL": (18.5, 2.2, 12.5, 0.8, 1.25),
    "SIDO": (22.5, 5.8, 25.8, 3.2, 0.05), "MAPI": (15.2, 3.2, 22.5, 1.5, 0.85),
    "ACES": (18.5, 3.5, 19.2, 2.8, 0.02), "CPIN": (14.5, 3.8, 26.5, 2.2, 0.42),
    "JPFA": (8.5, 1.5, 18.2, 3.5, 0.85), "MEDC": (5.2, 1.2, 24.5, 2.5, 0.95),
    "PGAS": (8.8, 1.1, 12.8, 5.5, 0.65), "ESSA": (12.5, 2.2, 18.5, 0.0, 0.45),
    "TOWR": (28.5, 5.5, 19.5, 1.8, 2.85), "TBIG": (32.5, 6.8, 21.2, 1.2, 3.15),
    "SMGR": (15.2, 1.5, 10.2, 3.5, 0.55), "INKP": (5.8, 0.8, 14.5, 2.2, 0.45),
    "BRPT": (18.5, 1.2, 6.5, 0.0, 0.85), "AMRT": (42.5, 12.5, 28.5, 0.8, 0.65),
    "ERAA": (8.5, 2.2, 26.5, 2.5, 0.35), "MNCN": (6.5, 0.8, 12.5, 5.8, 0.25),
    "SCMA": (8.2, 1.5, 18.5, 6.2, 0.12), "AKRA": (12.5, 2.5, 20.2, 3.2, 0.75),
    "UNTR": (8.2, 1.5, 18.8, 5.5, 0.55), "BBTN": (6.5, 0.8, 12.5, 3.8, 0.0),
    "BSDE": (12.5, 0.8, 6.5, 2.2, 0.45), "CTRA": (15.2, 1.2, 8.2, 1.5, 0.35),
    "SMRA": (18.5, 1.5, 8.5, 1.2, 0.65), "PWON": (8.5, 0.9, 10.5, 2.5, 0.25),
    "JSMR": (22.5, 2.2, 9.8, 1.2, 1.85), "WIKA": (12.5, 0.5, 4.2, 2.8, 1.45),
    "WSKT": (None, 0.3, 2.5, 0.0, 2.85), "PTPP": (8.5, 0.4, 4.8, 1.5, 1.65),
    "TPIA": (15.8, 1.8, 11.5, 0.5, 0.55), "EMTK": (25.5, 1.2, 4.8, 0.0, 0.15),
}
    ...
    async with get_session() as session:
        for symbol, (pe, pb, roe, div_yield, de) in FUNDAMENTALS.items():
            ...
            await session.execute(
                ...
                """),
                {
                    "id": str(uuid4()), "symbol": symbol, "date": today,
                    "pe": pe, "pb": pb, "roe": roe, "div": div_yield, "mcap": mcap, "de": de,
                },
            )
        await session.commit()
        ...
        for code, name, value, unit, period, source in indicators:
            await session.execute(
                text("""
                    ...
                    ON CONFLICT DO NOTHING
                """),
                {"id": str(uuid4()), "code": code, "name": name, "value": value, "unit": unit, "period": period, "source": source, "ref_date": date.today()},
            )
        await session.commit()
        ...
        for code, name, price, currency, unit in commodities:
            ...
            await session.execute(
                text("""
                    ...
                    ON CONFLICT DO NOTHING
                """),
                {"id": str(uuid4()), "code": code, "name": name, "price": price, "currency": currency, "unit": unit, "change": change, "pdate": date.today()},
            )
        await session.commit()
