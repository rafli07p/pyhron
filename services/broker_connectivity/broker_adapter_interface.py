...
Every broker integration (Alpaca, IDX FIX, etc.) must subclass
BrokerAdapterInterface and implement all async methods. The OMS and
reconciliation services depend only on this interface -- never on
concrete adapters.
"""
...
class BrokerAdapterInterface(ABC):
    ...
    Subclasses:
        - AlpacaBrokerAdapter: REST + WebSocket for US equities via Alpaca.
        - IDXFIXProtocolAdapter: FIX protocol for Indonesia Stock Exchange (stub).
    """
