"""Position reconciliation monitor for the Pyhron OMS.
...
class PositionReconciliationMonitor:
    ...
    def __init__(
        ...
        """Initialize the reconciliation monitor.

        Args:
            broker_adapters: Mapping of exchange name to broker adapter.
        """
    ...
    async def start(self) -> None:
        ...
        self._running = True
        logger.info("position_reconciliation_monitor_started")
    ...
    async def stop(self) -> None:
        ...
        logger.info("position_reconciliation_monitor_stopped")
