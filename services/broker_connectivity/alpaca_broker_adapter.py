...
Implements the BrokerAdapterInterface using Alpaca's REST API (v2) and
...
class AlpacaBrokerAdapter(BrokerAdapterInterface):
    ...
    def __init__(self) -> None:
        config = get_config()
        self._api_key: str = config.alpaca_api_key
        self._secret_key: str = config.alpaca_secret_key
        self._base_url: str = config.alpaca_base_url.rstrip("/")
