...
async def update_strategy(strategy_id: UUID, body: StrategyUpdate) -> StrategyResponse:
...
async def get_strategy_performance(strategy_id: UUID) -> StrategyPerformance:
