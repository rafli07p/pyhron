...
export const metadata = { title: 'Multi-Asset Research & Insights' };

const features = [
  { title: 'Cross-Asset Allocation', desc: 'Optimal allocation frameworks across Indonesian equities, bonds, sukuk, and money market instruments.' },
  { title: 'Risk Parity Strategies', desc: 'Risk-balanced portfolio construction spanning multiple IDX asset classes with dynamic rebalancing.' },
  { title: 'Macro Regime Analysis', desc: 'Identifying macro regimes and their impact on cross-asset correlations in Indonesian markets.' },
];
    ...
    <div className="bg-white">
      <section className="border-b border-black/[0.06] py-16">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <h1 className="mt-4 text-3xl font-bold text-black">Multi-Asset Research</h1>
          <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-black/50">Cross-asset allocation, risk parity, and macro regime research spanning Indonesian asset classes.</p>
        </div>
      </section>
